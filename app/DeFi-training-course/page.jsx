...
import TeacherPhoto from '@/app/Images/teacher-3.png';
import coursePhoto from '@/app/Images/course-photo-7.jpeg';

export default function BitcoinTrainingCourse() {
    const products = [
        {
            id: 1,
            title: 'آموزش تحلیل بازارهای مالی',
            price: 9000000,
            image: coursePhoto,
        },
    ];
            ...
            <div className='bg-gray-100 dark:bg-zinc-700'>
                <div className='container px-4' dir='rtl'>
                                ...
                                <div>
                                    <div>
                                        <div className="flex justify-between mb-1">
                                            ...
                                            <span className="text-base text-orange-400">30%</span>
                                        </div>
                                        <div className="w-full mb-5 bg-gray-200 rounded-full h-2.5 dark:bg-gray-700">
                                            <div className="bg-orange-400 h-2.5 rounded-full" style={{ width: '30%' }} />
                                        </div>
                                    </div>
                                    ...
                                    <div className='flex justify-between items-center my-3 bg-gray-200 dark:bg-gray-600 w-full rounded gap-1 p-2'>
                                        ...
                                        <div className='text-gray-700 dark:text-gray-200'>350</div>
                                    </div>
                                    <div className='flex justify-between items-center my-3 bg-gray-200 dark:bg-gray-600 w-full rounded gap-1 p-2'>
                                        <div className='flex items-center gap-1'>
                                        ...
                                        <span className='text-gray-700 dark:text-gray-200'>9 ساعت و 30 دقیقه</span>
                                    </div>
                                    <div className='flex justify-between items-center my-3 mb-0 bg-gray-200 dark:bg-gray-600 w-full rounded gap-1 p-2'>
                                        ...
                                        <span className='text-gray-700 dark:text-gray-200'>1403/08/19</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <DescriptionCourseBox
                        courseTitle='دوره آموزش تحلیل بازارهای مالی'
                        coursePhoto={coursePhoto}
                        teacherPhoto={TeacherPhoto}
                        teacherName='رامین محمدی'
                    />
                </div>
                <Footer />
            </div>
