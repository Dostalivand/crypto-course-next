...
//                         <div key={product.id} className='flex flex-col md:flex-col lg:flex-row xl:flex-row justify-between gap-3 pt-28'>
...
//                                             <div className='text-nowrap text-gray-700 dark:text-gray-800'>
